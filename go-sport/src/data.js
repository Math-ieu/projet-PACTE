...
export const community = {
  ...
  testimonials: [
    ...
    },
    {
      ...
      name: 'Lauren K.',
      message:
        'GO-Fit changed my life. Not only physically but mentally as well. I’m a better mother, and all around better human being because of this gym.”',
    },
    {
      image: CommunityImg3,
      name: 'Jhon D.',
      message:
        '“Love these workouts! Trainers are knowledgeable and motivating. Go-Fit is wonderful!”',
    },
    {
      image: CommunityImg4,
      name: 'Anne R.',
...
export const join = {
  ...
  subtitle:
    'We’ll keep you updated on the things you need to know about Go-Fit. Nothing more, nothing less.',
  btnText: 'Join now',
};

export const footer = {
  logo: Logo,
  copyrightText: 'All rights reserved. Hestim 2023.',
};