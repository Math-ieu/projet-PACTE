...
CREATE TABLE STATISTIQUE_FERME (
   ID_STATISTIQUE_FERME SERIAL NOT NULL,
   ID_RAPPORT_FERME INT4 NULL,
   NOM_STATISTIQUE CHAR(20) NULL,
   FICHIER_STATISTIQUE CHAR NULL,
   CONSTRAINT PK_STATISTIQUE_FERME PRIMARY KEY (ID_STATISTIQUE_FERME)
);

CREATE TABLE STATISTIQUE_OUVERT (
   ID_STATISTIQUE_OUVERT SERIAL NOT NULL,
   ID_RAPPORT_OUVERT INT4 NULL,
   NOM_STATISTIQUE CHAR(20) NULL,
   FICHIER_STATISTIQUE CHAR NULL,
   CONSTRAINT PK_STATISTIQUE_OUVERT PRIMARY KEY (ID_STATISTIQUE_OUVERT)
);
...
ALTER TABLE STATISTIQUE_OUVERT ADD CONSTRAINT FK_STATISTI_FAIRE_RAPPORTO FOREIGN KEY (ID_RAPPORT_OUVERT) REFERENCES RAPPORT_OUVERT (ID_RAPPORT) ON DELETE RESTRICT ON UPDATE RESTRICT;

ALTER TABLE STATISTIQUE_FERME ADD CONSTRAINT FK_STATISTI_FAIRE_RAPPORTF FOREIGN KEY (ID_RAPPORT_FERME) REFERENCES RAPPORT_FERME (ID_RAPPORT_FERME) ON DELETE RESTRICT ON UPDATE RESTRICT;